This repository contains the files for my project to determine if a patient has a heart disease based on their data with features such as age, heart rate, cholestrol as well as ecg data.
